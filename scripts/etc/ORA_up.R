ORA_up <- function (df, identity, detected_genes, title) {
  ...
  # remove Hmmr and FIJ5 from up regulated before ORA
  deg_up_sig_fc <- deg_up_sig_fc[!deg_up_sig_fc$gene == "Hmmr",]
  deg_up_sig_fc <- deg_up_sig_fc[!deg_up_sig_fc$gene == "FIJ5",]
